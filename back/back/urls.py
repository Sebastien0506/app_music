...
from back.app_back.views import get_all_music_category, download_music, get_all_music_favorites, add_favorite_music, get_csrf, register, login, me, logout, user_update, add_music, get_all_music, create_category, get_all_category, get_music_category, delete_category, get_all_music, delete_music, get_one_music, update_music
...
urlpatterns = [
    ...
    path('api/download_music/<int:music_id>/', download_music),
    path('api/get_all_music_category/<int:category_id>/', get_all_music_category),
]
